...
> [!CAUTION]
> The certificates required for this repository are not included. You need to extract them from the APK. An documentation & an extraction-script for windows can be found in the [docs](./docs) directory.
